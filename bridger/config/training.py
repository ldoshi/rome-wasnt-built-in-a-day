...
key = "training_batch_history_dir"
hparam_dict[key] = {"type": str, "default": "training_batch_history"}
help_str = "Path to folder in which training batch history will be saved"
hparam_dict[key]["help"] = help_str
