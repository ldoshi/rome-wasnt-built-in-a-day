...
def test():
    ...
    with object_logging.ObjectLogManager(hparams.object_logging_dir) as object_log_manager:
      if hparams.load_checkpoint_path:
          ...
          model = builder_trainer.BridgeBuilderModel(object_log_manager, hparams=hparams)
